...
#define HPF_CUTOFF_FREQ         18000.0
...
private:
    ...
    void            ApplyHighPassFilter();  // 高通滤波器
    ...
    // 高通滤波器状态变量 (一阶IIR高通滤波器)
    float         mHPF_x1;  // 上一个输入样本
    float         mHPF_y1;  // 上一个输出样本
    float         mHPF_alpha;  // 滤波器系数
